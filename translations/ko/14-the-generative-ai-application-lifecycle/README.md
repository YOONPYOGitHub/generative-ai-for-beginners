...
-->
[![함수 호출과 통합하기](../../../14-the-generative-ai-application-lifecycle/images/14-lesson-banner.png)](https://youtu.be/ewtQY_RJrzs?si=dyJ2bjiljH7UUHCh)
...
![LLMOps vs. MLOps 비교](../../../14-the-generative-ai-application-lifecycle/images/01-llmops-shift.png)
...
![LLMOps 인포그래픽](../../../14-the-generative-ai-application-lifecycle/images/02-llmops.png)
...
![LLMOps 워크플로우](../../../14-the-generative-ai-application-lifecycle/images/03-llm-stage-flows.png)
...
![Azure AI 가능성](../../../14-the-generative-ai-application-lifecycle/images/04-azure-ai-platform.png)

Azure AI는 운영, 서비스, 프로젝트, 벡터 검색 및 데이터베이스 요구 사항을 관리할 수 있는 다양한 리소스를 제공합니다.

![Azure AI를 활용한 LLMOps](../../../14-the-generative-ai-application-lifecycle/images/05-llm-azure-ai-prompt.png)
...
![PromptFlow를 활용한 LLMOps](../../../14-the-generative-ai-application-lifecycle/images/06-llm-promptflow.png)
