...
[![검색 증강 생성(RAG) 및 벡터 데이터베이스](../../../15-rag-and-vector-databases/images/15-lesson-banner.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![RAG의 작동 방식을 보여주는 그림](../../../15-rag-and-vector-databases/images/how-rag-works.png)
...
![RAG의 아키텍처를 보여주는 그림](../../../15-rag-and-vector-databases/images/encoder-decode.png)
...
![단어 cat의 임베딩](../../../15-rag-and-vector-databases/images/cat.png)
