...
[![생성형 AI와 대규모 언어 모델 소개](../../../08-building-search-applications/images/08-lesson-banner.png)](https://youtu.be/W0-nzXjOjr0?si=GcsqiTTvd7RKbo7V)
...
![Azure ML에서 rstudio를 사용할 수 있나요?라는 질문에 대한 의미론적 검색](../../../08-building-search-applications/images/query-results.png)
...
![사용자가 쿼리를 입력할 수 있는 입력 상자](../../../08-building-search-applications/images/notebook-search.png)
