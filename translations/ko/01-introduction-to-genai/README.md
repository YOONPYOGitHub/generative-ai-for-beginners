...
[![생성형 AI와 대규모 언어 모델 소개](../../../01-introduction-to-genai/images/01-lesson-banner.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![다섯 명의 젊은 학생들이 모니터를 보고 있는 모습 - DALLE2 제작 이미지](../../../01-introduction-to-genai/images/students-by-DALLE2.png)
...
![AI, ML, DL 및 생성형 AI](../../../01-introduction-to-genai/images/AI-diagram.png?WT.mc_id=academic-105485-koreyst)
...
![토크나이저 예시](../../../01-introduction-to-genai/images/tokenizer-example.png)
...
- **출력 유형을 지정하는 지침**. 이 지침은 때로는 몇 가지 예제나 추가 데이터를 포함할 수 있습니다.
  ...
  1. 기사, 책, 제품 리뷰 등의 요약 및 비정형 데이터에서 통찰력 추출.
    ...
    ![요약 예시](../../../01-introduction-to-genai/images/summarization-example.png)
  
  2. 기사, 에세이, 과제 등의 창의적 아이디어 및 디자인.
      
     ![창의적 글쓰기 예시](../../../01-introduction-to-genai/images/creative-writing-example.png)

- **에이전트와의 대화 형태로 질문**.
  
  ![대화 예시](../../../01-introduction-to-genai/images/conversation-example.png)

- **완성해야 할 텍스트 조각**, 이는 암묵적으로 글쓰기 지원 요청을 의미합니다.
  
  ![텍스트 완성 예시](../../../01-introduction-to-genai/images/text-completion-example.png)

- **코드 조각**과 함께 이를 설명하고 문서화하거나 특정 작업을 수행하는 코드 생성을 요청하는 주석.
  
  ![코딩 예시](../../../01-introduction-to-genai/images/coding-example.png)
