...
[![다양한 LLM 탐구 및 비교](../../../02-exploring-and-comparing-different-llms/images/02-lesson-banner.png)](https://youtu.be/KIRUeDKscfI?si=8BHX1zvwzQBn-PlK)
...
![Foundation Models versus LLMs](../../../02-exploring-and-comparing-different-llms/images/FoundationModel.png)
...
![Foundation Model](../../../02-exploring-and-comparing-different-llms/images/Multimodal.png)
...
![Embedding](../../../02-exploring-and-comparing-different-llms/images/Embedding.png)
...
![Image generation](../../../02-exploring-and-comparing-different-llms/images/Image.png)
...
![Text and code generation](../../../02-exploring-and-comparing-different-llms/images/Text.png)
...
![모델 카탈로그](../../../02-exploring-and-comparing-different-llms/images/AzureAIStudioModelCatalog.png)

- 모델 카드 검토: 사용 의도와 학습 데이터, 코드 샘플, 내부 평가 라이브러리의 평가 결과에 대한 자세한 설명을 포함합니다.

![모델 카드](../../../02-exploring-and-comparing-different-llms/images/ModelCard.png)
...
![모델 벤치마크](../../../02-exploring-and-comparing-different-llms/images/ModelBenchmarks.png)

- 특정 작업에서 모델 성능을 향상시키기 위해 사용자 지정 학습 데이터를 사용하여 모델을 미세 조정할 수 있습니다. Azure AI Studio의 실험 및 추적 기능을 활용합니다.

![모델 미세 조정](../../../02-exploring-and-comparing-different-llms/images/FineTuning.png)
...
![모델 배포](../../../02-exploring-and-comparing-different-llms/images/ModelDeploy.png)
...
![LLMs 배포](../../../02-exploring-and-comparing-different-llms/images/Deploy.png)
