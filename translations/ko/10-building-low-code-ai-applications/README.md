...
[![저코드 AI 애플리케이션 구축하기](../../../10-building-low-code-ai-applications/images/10-lesson-banner.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![만들고자 하는 앱 설명하기](../../../10-building-low-code-ai-applications/images/copilot-chat-prompt-powerapps.png)
...
1. AI Copilot은 추적하려는 데이터를 저장하기 위한 필드와 샘플 데이터를 포함한 Dataverse 테이블을 제안합니다. 이후 대화형 단계로 AI Copilot 비서 기능을 사용하여 테이블을 사용자 정의할 수 있습니다.
   ...
   ![새 테이블의 제안된 필드](../../../10-building-low-code-ai-applications/images/copilot-dataverse-table-powerapps.png)
...
![새 필드 추가하기](../../../10-building-low-code-ai-applications/images/copilot-new-column.png)
...
![프롬프트 지시를 통해 새 화면 추가하기](../../../10-building-low-code-ai-applications/images/copilot-new-screen.png)
...
![새 테이블 선택](../../../10-building-low-code-ai-applications/images/describe-new-table.png)
...
![테이블 설명](../../../10-building-low-code-ai-applications/images/copilot-chat-prompt-dataverse.png)
...
![제안된 Dataverse 테이블](../../../10-building-low-code-ai-applications/images/copilot-dataverse-table.png)
...
![AI Builder 모델](../../../10-building-low-code-ai-applications/images/ai-builder-models.png)
...
2. 홈 화면의 텍스트 영역을 사용하여 구축하려는 워크플로우를 설명합니다. 예를 들어, **_내 메일함에 송장이 도착하면 처리합니다_**라고 입력합니다. **Send** 버튼을 클릭하여 AI Copilot에 프롬프트를 보냅니다.
   ...
   ![Copilot Power Automate](../../../10-building-low-code-ai-applications/images/copilot-chat-prompt-powerautomate.png)
...
8. 흐름에서 **Condition** 작업을 제거합니다. 사용하지 않을 것입니다. 흐름은 다음 스크린샷과 같아야 합니다:
   ...
   ![Power Automate, 작업 제거](../../../10-building-low-code-ai-applications/images/powerautomate-remove-actions.png)
...
11. 이전에 생성한 **Table**을 선택합니다. 예를 들어, **Invoice Information** 테이블을 선택할 수 있습니다. 이전 작업의 동적 콘텐츠를 사용하여 다음 필드를 채웁니다:
    ...
    ![Power Automate 행 추가](../../../10-building-low-code-ai-applications/images/powerautomate-add-row.png)
...
![프롬프트 생성](../../../10-building-low-code-ai-applications/images/create-prompt-gpt.png)
