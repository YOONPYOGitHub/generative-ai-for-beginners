...
[![생성 AI 기반 채팅 애플리케이션 구축](../../../07-building-chat-applications/images/07-lesson-banner.png)](https://youtu.be/R9V0ZY1BEQo?si=IHuU-fS9YWT8s4sA)
...
![ChatGPT의 사용자 정의 지침 설정](../../../07-building-chat-applications/images/custom-instructions.png)

이 "프로필"은 ChatGPT가 연결 리스트에 대한 강의 계획을 작성하도록 요청합니다. ChatGPT는 사용자가 경험에 따라 더 깊이 있는 강의 계획을 원할 수 있다는 점을 고려합니다.

![연결 리스트에 대한 강의 계획을 요청하는 ChatGPT 프롬프트](../../../07-building-chat-applications/images/lesson-plan-prompt.png)
